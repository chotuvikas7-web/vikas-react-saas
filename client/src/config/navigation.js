...
export const superModules = [
  ...
  { group: 'Tenant Management', items: ['Company Details', 'Company Status', 'Company Requests', 'Suspended Companies', 'Company Usage', 'Company Storage'].map((label) => ({ label, path: `/super-admin/modules/${slug(label)}` })) },
